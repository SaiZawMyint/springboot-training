	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers("/edit/**", "/delete/**").hasAnyRole("ADMIN", "MANAGER")
						...
						.requestMatchers(HttpMethod.POST, "/user_setup").hasAnyRole("ADMIN", "MANAGER")
						.requestMatchers("/user_list").hasAnyRole("ADMIN", "MANAGER")*/

						.requestMatchers(HttpMethod.GET, "/role_setup").hasRole("ADMIN")
						.requestMatchers(HttpMethod.POST, "/role_setup").hasAnyRole("ADMIN", "MANAGER")
						.requestMatchers("/role_list").hasAnyRole("ADMIN", "MANAGER")

						.requestMatchers(HttpMethod.GET, "/productcategory-setup").hasRole("ADMIN")
						.requestMatchers(HttpMethod.POST, "/productcategory_setup").hasAnyRole("ADMIN", "MANAGER")
						.requestMatchers("/productcategory-list").hasAnyRole("ADMIN", "MANAGER")

						// Everything else -> must be authenticated
						.anyRequest().authenticated())
				.formLogin(form -> form.loginPage("/login").loginProcessingUrl("/layouts/base-layout")
